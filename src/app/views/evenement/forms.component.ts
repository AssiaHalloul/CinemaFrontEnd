...
export class FormsComponent implements OnInit {
  ...
  // this function allow us to get all  evenements
  getEvenements() {
  ...
  // this function allow us to get all films
  getFilms(){
  ...
  // this function allow us to get all evenements types
  getEventsTypes(){
  ...
  // this function for uploading images
  onSelectFile(event) {
